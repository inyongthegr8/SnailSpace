...
import com.celestialsnails.covid19.images.BlackAndWhiteConversion;
...
public class FloodFill extends BitmapConverter {
	...
	private final com.celestialsnails.covid19.images.FloodFill floodFill;

	public FloodFill(Bitmap bitmap, int color) {
		super(bitmap);
		this.color = color;
		floodFill = new com.celestialsnails.covid19.images.FloodFill(getPixelsOfBitmap(), getWidth(), getHeight(), BORDER_COLOR);
	}
